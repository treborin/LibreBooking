  ...
  EmailTemplateManagement.prototype.init = function () {
    ...
    elements.templateOpts.on('change', function (e) {
      ...
      if (templateName == '') {
        ...
        ajaxGet(
          options.scriptUrl + '?dr=template&lang=' + elements.languageOpts.val() + '&tn=' + templateName,
          null,
          loadTemplate
        );
      }
    ...
    elements.reloadEmailContents.on('click', function (e) {
      ...
      var templateName = elements.templateOpts.val();
      ajaxGet(
        options.scriptUrl + '?dr=originalTemplate&lang=' + elements.languageOpts.val() + '&tn=' + templateName,
        null,
        loadTemplate
      );
    });
