...
class it_it extends en_us
{
    ...
    protected function _LoadStrings()
    {
        ...
        $strings['ResourcePermissionAutoGranted'] = 'Disponibilità automatica immediata';
        ...
        $strings['ReservationRequiresApproval'] = 'Una o più risorse prenotate richiedono approvazione. La prenotazione rimarrà fino ad allora in sospeso.';
        ...
        $strings['AutoReleaseNotification'] = 'Cancellata automaticamente se non vi è un check-in entro %s minuti';
        ...
        $strings['WaitlistRequestAdded'] = 'Sarai avvisato se questo orario diventerà disponibile';
        ...
        $strings['ResourceImportInstructions'] = '<ul><li>I file devono essere in formato CSV e con codifica UTF-8.</li><li>Il campo nome è obbligatorio. Lasciando vuoti gli altri campi si erediteranno i valori di default.</li><li>I possibili valori per lo Stato sono \'Disponibile\', \'Non disponibile\' e \'Nascosta\'.</li><li>Colore deve essere il valore esadecimale. es) #ffffff.</li><li>Le colonne Assegna automaticamente e approva possono essere vero o falso.</li><li>La validità degli attributi non verrà forzata.</li><li>I gruppi di risorsa multipli devono essere separati da virgola.</li><li>Si usi il template fornito come esempio.</li></ul>';
        $strings['ReservationImportInstructions'] = '<ul><li>I file devono essere in formato CSV e con codifica UTF-8.</li><li>I campi email, nome risorsa, inizio e fine sono obbligatori.</li><li>I campi inizio e fine richiedono data e ora. Il formato raccomandato è YYYY-mm-dd HH:mm (2017-12-31 20:30).</li><li>Ruoli, conflitti, e fasce orarie non verranno controllati.</li><li>Le Notifiche non verranno inviate.</li><li>La validità degli attributi non verrà forzata.</li><li>I nomi di risorsa multipli devono essere separati da virgola.</li><li>Si usi il template fornito come esempio.</li></ul>';
        ...
        $strings['DeleteMultipleUserWarning'] = 'Eliminando questi utenti eliminerai tutte le loro prenotazioni passate, presenti e future. Nessuna email verrà inviata.';
        ...
        $strings['CreditsUpdated'] = 'Il costo di un credito è stato aggiornato';
        ...
        $strings['BuyMoreCredits'] = 'Compra più crediti';
        ...
        $strings['ScheduleAvailabilityEarly'] = 'Questo calendario non è ancora disponibile. Disponibile';
        ...
        $strings['ScheduleConcurrentMaximumNone'] = 'Non c\'è limite al numero di risorse che si possono prenotare in contemporanea';
        $strings['ScheduleMaximumConcurrent'] = 'Massimo numero di risorse prenotate in contemporanea';
        $strings['ScheduleMaximumConcurrentNote'] = 'Quando popolato, il numero totale di risorse che si possono prenotare in contemporanea per questo calendario sarà limitato.';
        ...
        $strings['GroupsImportInstructions'] = '<ul><li>I file devono essere in formato CSV e con codifica UTF-8.</li><li>Il campo nome è obbligatorio.</li><li>La lista dei membri deve essere una lista di indirizzi email separata da virgole.</li><li>Una lista dei membri vuota non modificherà il gruppo.</li><li>La lista dei permessi deve essere una lista di risorse separata da virgole.</li><li>Una lista dei permessi vuota non modificherà i permessi del gruppo.</li><li>Si usi il template fornito come esempio.</li></ul>';
        ...
        $strings['CheckingAvailabilityError'] = 'Disponibilità della risorsa non disponibile - troppe risorse';
        // End Strings
        ...
        $strings['DatabaseCredentials'] = 'È necessario fornire le credenziali di un utente MySQL con privilegi sufficienti alla creazione del database. Se non si conoscono, contattare l\'amministratore del database. In molti casi, \'root\' funziona.';
        ...
        $strings['ScheduleAvailabilityError'] = 'Questo calendario è disponibile tra %s e %s';
    ...
    protected function _LoadDays()
    {
         ...
         ***/
        // The full day name
        $days['full'] = ['Domenica', 'Lunedì', 'Martedì', 'Mercoledì', 'Giovedì', 'Venerdì', 'Sabato'];
