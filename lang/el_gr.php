...
class el_gr extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        $strings['PasswordError'] = 'Το συνθηματικό πρέπει να περιέχει τουλάχιστον %s χαρακτήρες, %s αριθμούς και %s ειδικούς χαρακτήρες.';
        $strings['PasswordErrorRequirements'] = 'Το συνθηματικό πρέπει να περιέχει ένα συνδυασμό από τουλάχιστον %s κεφαλαίους και πεζούς χαρακτήρες, %s αριθμούς και %s ειδικούς χαρακτήρες.';
